...
(102,'rama',35,'ECE',60000,'CC','1985-12-23'),
(204,'rao',34,'EEE',50000,'Asst.Professor','1986-04-29'),
(314,'Ramu',29,'CSE',40000,'CC','1991-06-06'),
(230,'Kalyani',32,'ECE',55000,'HOD','1988-03-26'),
(190,'Lakshman',28,'IT',450000,'Asst.Professor','1992-11-10'),
(340,'satish',27,'CSE',55000,'professor','1993-07-06');
...
#update
update  Employees_details_EP set empNmae='somu' where empid=101;
